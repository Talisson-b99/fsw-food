...
const createJuices = async (restaurantId: string, categoryId: string) => {
  ...
  const juiceProducts = [
    ...
    },
    {
      ...
      price: 12,
      description:
        "Desperte seus sentidos com a nossa refrescante e revigorante explosão de sabor cítrico: o suco de laranja fresco e natural. Cada gole deste suco oferece o doce aroma e o sabor vibrante das laranjas recém-espremidas, diretamente da natureza para o seu copo. Rico em vitamina C e nutrientes essenciais, nosso suco de laranja é uma escolha refrescante e saudável para acompanhar suas refeições ou simplesmente para desfrutar a qualquer momento do dia. Refresque-se e revitalize-se com o sabor ensolarado e nutritivo deste clássico favorito.",
      discountPercentage: 5,
      imageUrl:
    ...
    },
    {
      ...
      price: 12,
      description:
        "Desfrute de um sabor tropical e revigorante com nosso suco de abacaxi fresco e natural. Cada gole deste suco oferece uma explosão de doçura tropical, combinada com um toque refrescante que é perfeito para qualquer momento do dia. Feito com abacaxis maduros e suculentos, nosso suco é uma fonte natural de energia e vitalidade. Refresque-se e revitalize seu dia com o sabor suculento e exótico do abacaxi, capturado em cada garrafa deste suco delicioso e nutritivo.",
      discountPercentage: 7,
      imageUrl:
    ...
    },
    {
      ...
      price: 12,
      description:
        "Refrescante e delicioso, nosso suco de melancia é a escolha perfeita para se refrescar em dias quentes ou para acompanhar suas refeições. Feito com melancias frescas e suculentas, cada gole deste suco oferece uma explosão de sabor doce e natural. Rico em nutrientes e hidratante, é uma opção saudável e revigorante para todas as idades. Experimente o frescor da melancia em cada gota deste suco irresistível.",
      discountPercentage: 5,
      imageUrl:
